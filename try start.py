...
#         # 🔹 مرحلة غمض العين لتشغيل البرنامج
#         # cv2.putText(frame, f"{blinking_ratio}", (100,120), font, 9, 0, 3)
#         if blinking_ratio > 5:
#             blinking_frames += 1
#             cv2.putText(frame, f"{show_home_times+1}/3", (80,100), font, 9, 0, 3)
...
#             # زيادة العداد
#         if blinking_frames >= frames_to_blink and show_home_times < 3:
#             if blinking_ratio < 4:
#                 show_home_times += 1
#                 blinking_frames = 0
...
#             # تشغيل البرنامج بعد 3 غمضات
#             if show_home_times == 3:
...
while True:
    ...
    # عرض الحروف
    if program_started and not selected_keyboard_menu:
